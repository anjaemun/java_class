...
public class MemberService {
    ...
    public void SignUp() {
        ...
        boolean result2 = memberRepository.SignUp(memberDTO);
        if (!result2) {
    ...
    public void memberList() {
        Map<Long, MemberDTO> memberDTOMap = memberRepository.memberList();
        for (Long i : memberDTOMap.keySet()) {
            System.out.println("memberDTOMap = " + memberDTOMap.get(i));
            System.out.println("memberDTOMap = " + memberDTOMap.get(i).getMemberEmail());
        }
    }
